...
# 4 "C:\Program Files\Microchip\xc8\v2.31\pic\include\__size_t.h"
...
# 18 "C:\Program Files\Microchip\xc8\v2.31\pic\include\xc.h"
...
# 7 "C:\Program Files\Microchip\xc8\v2.31\pic\include\builtins.h"
...
# 109 "C:\Program Files\Microchip\xc8\v2.31\pic\include\proc\pic16f18446.h"
...
extern volatile __bit ADCAL __at(0x88F);
...
extern volatile __bit CHSN3 __at(0x893);
...
extern volatile __bit LATB4 __at(0xCC);


extern volatile __bit LATB5 __at(0xCD);


extern volatile __bit LATB6 __at(0xCE);


extern volatile __bit LATB7 __at(0xCF);
...
extern volatile __bit LATC6 __at(0xD6);


extern volatile __bit LATC7 __at(0xD7);
...
extern volatile __bit P3M1 __at(0x18B7);


extern volatile __bit P4M1 __at(0x18D7);
...
extern volatile __bit TRISB4 __at(0x9C);


extern volatile __bit TRISB5 __at(0x9D);


extern volatile __bit TRISB6 __at(0x9E);


extern volatile __bit TRISB7 __at(0x9F);
...
extern volatile __bit TRISC6 __at(0xA6);


extern volatile __bit TRISC7 __at(0xA7);
...
extern volatile __bit VCFG01 __at(0x894);


extern volatile __bit VCFG11 __at(0x895);
...
# 76 "C:\Program Files\Microchip\xc8\v2.31\pic\include\pic.h"
...
# 114 "C:\Program Files\Microchip\xc8\v2.31\pic\include\eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);

# 127 "C:\Program Files\Microchip\xc8\v2.31\pic\include\pic.h"
...
static uint8_t i2c1_rx_buffer[32];
static uint8_t i2c1_tx_buffer[32];
...
void I2C1_GetCommandData(uint8_t * data, uint8_t * len){
__builtin_memcpy(data,i2c1_rx_buffer,rxLen);
*len = rxLen;
}

void I2C1_SetTransmitData(uint8_t * data, uint8_t len){

while((txCnt < len) && (txCnt < 32)){
i2c1_tx_buffer[txCnt] = data[txCnt];
txCnt++;
}
txLen = txCnt;
txCnt = 0;
